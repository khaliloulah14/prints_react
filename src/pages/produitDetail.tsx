...
const products: { id: number; name: string; category: string; price: number; image: string }[] = [
    // CATEGORIE : CAPS
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      ...
      <div className="bg-blue-100 shadow-lg rounded-xl p-10 max-w-md">
        ...
        <p>
            ...
            <button className="mt-4 w-full bg-red-500 text-white py-3 rounded-lg hover:bg-red-600 transition duration-300">
                supprimer
            </button>
        </p>
